...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex lg:flex-col w-64 min-h-screen bg-slate-900/80 backdrop-blur-xl border-r border-white/5 p-6">
      {/* Logo */}
      ...
      <nav className="flex-1 space-y-1">
        <p className="text-[11px] font-semibold text-slate-500 uppercase tracking-wider mb-3 px-4">
          Menu
        </p>
        {navItems.map((item) => {
