...
export default function BottomNav() {
  ...
  return (
    <nav className="lg:hidden fixed bottom-0 inset-x-0 z-50 
                    ...
                    safe-area-inset-bottom transition-colors duration-300">
          ...
          return (
            <Link
              ...
              className={`
                ...
                ${isActive ? "text-brand-400" : "text-slate-500 dark:text-slate-500 hover:text-slate-300 dark:hover:text-slate-300"}
              `}
            >
