  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:flex-1 relative overflow-hidden bg-gradient-to-br from-surface-900 via-surface-800 to-brand-900/30">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,_rgba(31,199,212,0.15),transparent_70%)]" />
        <div className="relative z-10 flex flex-col justify-center px-16 xl:px-24">
          ...
          <h1 className="text-5xl xl:text-6xl font-bold text-white leading-tight mb-6">
            Start Your<br />
            <span className="gradient-text">Fitness</span><br />
            Transformation
          </h1>
          <p className="text-lg text-slate-400 max-w-md leading-relaxed">
            Join thousands of people who&apos;ve transformed their lives with
            AI-powered fitness coaching and intelligent tracking.
          </p>

          <div className="mt-12 space-y-4">
            {["AI-powered workout plans", "Smart nutrition tracking", "Real-time progress analytics"].map(
              (feat) => (
      ...
      <div className="flex-1 lg:max-w-lg xl:max-w-xl flex items-center justify-center p-6 sm:p-10">
        <div className="w-full max-w-sm">
          ...
          <Button variant="secondary" fullWidth size="lg" onClick={handleGoogleSignIn}>
